...
export function DiscoveryHub({items,watched,onOpen,onOpenSequence}:{items:DiscoveryItem[];watched:Set<string>;onOpen:(id:string)=>void;onOpenSequence:(sequence:DiscoverySequence)=>void}) {
